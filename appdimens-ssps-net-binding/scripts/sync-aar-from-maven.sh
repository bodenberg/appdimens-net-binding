...
# Baixa a AAR appdimens-ssps do Maven Central para Jars/, e os metadados
...
ARTIFACT="appdimens-ssps"
GROUP_PATH="io/github/bodenberg"
BASE_URL="https://repo1.maven.org/maven2/${GROUP_PATH}/${ARTIFACT}/${AAR_VERSION}"

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
JARS_DIR="${SCRIPT_DIR}/../AppDimens.Ssps.Binding/Jars"
MAVEN_DIR="${SCRIPT_DIR}/../AppDimens.Ssps.Binding/Maven"
